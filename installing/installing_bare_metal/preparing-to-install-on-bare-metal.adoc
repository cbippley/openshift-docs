...
[role="_abstract"]
To prepare for a successful {product-title} installation on bare-metal, you must select an installation method and plan your network configuration. Reviewing these requirements helps you ensure that your environment supports high availability and satisfies organizational controls.
...
xref:../installing/installing_bare_metal/modules/virt-planning-bare-metal-cluster-for-ocp-virt.adoc#virt-planning-bare-metal-cluster-for-ocp-virt[Bare-metal cluster installation requirements for {VirtProductName}]
...
[id="bare-metal-installation-infrastructure-options"]
== Bare metal infrastructure installation options
