...
[role="_abstract"]
Diagnose and resolve common KMS encryption issues.
...
[WARNING]
====
Permanently deleted KMS keys prevent data recovery without backups. Align key retention policies with backup retention.
====
...
*Symptom:* KMS encryption migration takes unusually long or appears stuck.
...
* Migration time is proportional to data size; monitor progress and wait for completion
