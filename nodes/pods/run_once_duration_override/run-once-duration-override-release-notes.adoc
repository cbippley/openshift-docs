...
The following advisory is available for the {run-once-operator} 1.2.0: link:https://errata.devel.redhat.com/advisory/135857[change this link when it becomes RHSA]

[id="RODOO-operator-1-2-0-new-features-and-enhancements"]
